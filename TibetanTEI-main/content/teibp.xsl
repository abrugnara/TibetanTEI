...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xd:doc>
		<xd:desc>
			<xd:p>A hack because JavaScript was doing weird things with &lt;title>, probably due to
				confusion with HTML title. There is no TEI <br/> namespace in the TEI Boilerplate
				output because JavaScript, or at least JQuery, cannot manipulate the TEI
				elements/attributes if they <br/> are in the TEI namespace, so the TEI namespace is
				stripped from the output. As far as I know, &lt;title> elsewhere does not cause any
				problems, <br/> but we may need to extend this to other occurrences of &lt;title>
				outside the Header.</xd:p>
		</xd:desc>
	</xd:doc>
	...
	<xsl:template name="htmlHead">
		<head>
			...
			<script xmlns="http://www.w3.org/1999/xhtml" type="text/javascript"><!--
                    wfd: JS for switching text views//-->
                function switchCustomCSS(theme) {
                    document.getElementById('withtrans_css').href = theme.options[theme.selectedIndex].value;
                }</script>
			<link xmlns="http://www.w3.org/1999/xhtml" id="notrans_css" rel="stylesheet"
				type="text/css" href="../css/custom_notrans.css"/>
			<link xmlns="http://www.w3.org/1999/xhtml" id="withtrans_css" rel="stylesheet"
				type="text/css" href="../css/custom_withtrans.css"/>
	...
	<xsl:template name="teibpToolbox">
		<div id="teibpToolbox">
			<div>
				<h1>Redaktionelle Grundsätze</h1>
				<list>
					<item><b>Benutzte Begriffe:</b> (<blue>Personen</blue>, <orange>Orte</orange>,
							<green>Titel</green>, <pink>Datum</pink>, <red>Partikel/Suffixe</red>,
							<brown>Verben</brown>) Links zu <a style="color:black"
							href="https://library.bdrc.io/">BUDA</a>, <a style="color:black"
							href="https://www.istb.univie.ac.at/kanjur/">rKTs</a>, <a
							style="color:black" href="https://sakyaresearch.org/">SRC</a> und Tohoku
						Katalog (<a style="color:black"
							href="http://purl.bdrc.io/resource/MW1KG13833">Kanakura et al.
						1953</a>)</item>
					<item>
						<b>Überschriften</b>
						<!-- and <b>dates</b> -->
					</item>
					<item>Beschönigt{...}</item>
					<item>Lücken [---]</item>
					<item>Direkte Rede "..."</item>
					<item>Korrekturen/Berichtigungen (=...)</item>
					<item>
						<dashed>undeutlich</dashed>
					</item>
				</list>
			</div>
			<div>
				<h1>Textansicht</h1>
				<label for="pbToggle">Verbergen der Folios/Paginierung</label>
				<input type="checkbox" id="pbToggle"/>
			</div>
			<p/>
			<div>
				<!-- wfd: select text view mode -->
				<h1>Übersetzung</h1>
				<select xmlns="http://www.w3.org/1999/xhtml" style="display:inline;" id="themeBox"
					onchange="switchCustomCSS(this);">
					<option value="../css/custom_withtrans.css">Zeige Übersetzung</option>
					<option value="../css/custom_notrans.css">Verberge Übersetzung</option>
				</select>
			</div>
			<!-- 	 		<div>
				<h3>Themes:</h3>
